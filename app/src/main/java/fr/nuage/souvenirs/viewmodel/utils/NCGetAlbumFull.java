...
public class NCGetAlbumFull extends RemoteOperation {
    ...
    public NCGetAlbumFull(AlbumNC album) {
        this.album = album;
    }
    ...
    protected RemoteOperationResult run(OwnCloudClient client) {
        ...
        try {
            // remote request
            getMethod = new GetMethod(client.getBaseUri() + API_ALBUM_URL + "/" + album.getId().toString() + "/full");
